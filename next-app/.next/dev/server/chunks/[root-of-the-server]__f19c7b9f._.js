...
async function GET() {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aiChats.findMany({
            where: {
...
async function POST(req) {
    try {
        ...
        const aiResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$aichat$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(chatFromUser);
        // making the string more simple for parsing
        const response = aiResponse.replace(/```json/gi, "").replace(/```/g, "").trim();
        try {
            // parsing the reponse from the ai
            const parseResponse = JSON.parse(response);
            // storing the chat of ai and the user in the db
            const storeReponseInTheDb = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aiChats.create({
                data: {
                    userId: Number(session?.user?.id),
            ...
            const updateTheCarbonEmission = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.update({
                where: {
                    id: Number(session?.user?.id)
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f19c7b9f._.js.map